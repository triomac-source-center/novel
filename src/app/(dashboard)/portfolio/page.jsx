      ...
      <Card className="mt-6 border-border shadow-sm">
        ...
        <CardContent>
          {investmentTransactions.length === 0 ? (
            <EmptyState icon={TrendingUp} title="No investment activity yet" description="Buying cells and cell transfers will show up here, separate from your wallet history." />
          ) : (
            <div className="rounded-xl border border-border">
              <Table>
                <TableHeader>
